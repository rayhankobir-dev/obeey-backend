...
// auth routes
authRouter.post("/login", validation(authSchema.login), loginController);
authRouter.post("/signup", validation(authSchema.signup), signUpController);
authRouter.post("/send-otp", authentication, otpController.sendOtp);
authRouter.post(
  "/verify-otp",
